...
`AGENTS.md` is the authoritative operating manual. Topic-specific manuals use two
filename families:
...
`CLAUDE.md` is only an alias to `AGENTS.md`; it is not a separate topic manual.
